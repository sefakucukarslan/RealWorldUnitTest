...
namespace RealWorldUnitTest.Test
{
    public class ProductApiControllerTest
    {
        ...
        public async void PostProduct_ActionExecutes_ReturnCreatedAtAction()
        {
            ...
            _mockRepo.Setup(x => x.Create(product)).Returns(Task.CompletedTask);//geriye bir text döndüğü için Task.CompletedTask dedik.
        ...
        public async void DeleteProduct_IdInValid_ReturnNotFound(int productId)
        {
            ...
            Assert.IsType<NotFoundResult>(resultNotFound.Result); // Task<ActionResult<Product>> geriye böyle bir dönüş yaptığı için (resultNotFound.Result) böyle yaptık.
        }
        ...
        public async void DeleteProduct_ActionExecute_ReturnNoContent(int productId)
        {
            ...
            //ilk olarak GetById'yi mocklamamız lazım biz burayı mocklayacaz ki null değerini kontrol edip if koşuluna girmesin.
            _mockRepo.Setup(x => x.GetById(productId)).ReturnsAsync(product);
